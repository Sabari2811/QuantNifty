...
class TradingConfig:
    """Central NIFTY-only trading configuration."""
    ...
    # NIFTY strategy is selective: one open position and at most three closed
    # trades in a trading day. Quality gates may result in fewer or zero trades.
