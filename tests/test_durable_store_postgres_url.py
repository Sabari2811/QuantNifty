...
def test_render_postgresql_url_uses_psycopg3_and_tls():
    assert (
...
def test_legacy_postgres_url_uses_psycopg3_and_tls():
    assert (
...
def test_existing_psycopg2_url_is_upgraded_with_tls():
    assert (
